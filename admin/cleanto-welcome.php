               ...
               <div class="panel-body">
                  <div class="ct-changelog-menu col-md-3 col-sm-4 col-xs-12 col-lg-3 np">
                     <ul class="nav nav-tab nav-stacked">
                        <li class="active"><a href="#version7_8" data-toggle="pill">What's new in 7.8? </a></li>
                  ...
                  <div class="changelog-details tab-pane active" id="version7_8">
