    ...
    <div class="ct-setting-details tab-content col-md-9 col-sm-9 col-lg-9 col-xs-12">
            ...
            <div class="tab-pane fade in" id="general-setting">
                ...
                <tr>
                        ...
                        <input data-toggle="toggle" data-size="small" type='checkbox' name="ct_staff_regist" <?php  if($setting->ct_staff_registration=='Y'){echo 'checked';}?> id="ct_staff_regist" data-on="<?php echo $label_language_values['enable'];?>" data-off="<?php echo $label_language_values['disable'];?>" data-onstyle='success' data-offstyle='danger' />
                      </label>
                                        </div>
								...
								<table id="ct-special-offer-list" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        while($row = @mysqli_fetch_array($allspecialoffer)) {
                                            ...
                                            <tr id="couponspecdata_row<?php  echo $row['id']; ?>">
                                                ...
                                                <td>
                                                    <a href="#update-special-offer-form<?php  echo $row['id']; ?>"
                                                       data-id="<?php echo $row['id']; ?>"
                                                       data-toggle="tab"
                                                       class="btn-circle btn-info btn-xs ct-edit-specoff"
                                                       title="<?php echo $label_language_values['edit_coupon_code'];?>">
                                                        <i class="fa fa-pencil-square-o"></i>
                                                    </a>

                                                    <a id="ct-delete-special-off"
                                                       data-toggle="popover"
                                                       class="pull-right btn-circle btn-danger btn-xs delete-spec-off"
                                                       data-id="<?php echo $row['id']; ?>"
                                                       rel="popover"
                                                       data-placement="left"
                                                       title="<?php echo "Delete Special Offer";?>">
                                                        <i class="fa fa-trash"></i>
                                                    </a>
                                                    ...
                                                    <td>
                                                        <div class="form-group">
                                                            <select name="coupon_type" id="edit_offer_type<?php  echo $rowso['id'];?>" class="selectpicker" data-size="3"  style="display: none;">
                                                                <option value="P" <?php  if($rowso['coupon_type']=='P') {echo "selected";} ?>><?php echo $label_language_values['percentage'];?></option>
                                                                <option value="F" <?php if($rowso['coupon_type']=='F') {echo "selected";} ?>><?php echo $label_language_values['flat'];?></option>
                                                            </select>
                                                        </div>
                                                    </td>
                                                </tr>
